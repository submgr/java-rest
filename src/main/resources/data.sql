...
--Вопросы
INSERT INTO questions (quiz_id, quiz_name, question, variant1, variant2, variant3, answer, question_scores)
VALUES  (1,'Страны', 'Какой город является столицей Италии?','Рим','Милан','Венеция', 'Рим', 5),
        (1, 'Страны', 'В какой стране находится город Мачу-Пикчу?','Португалия','Испания','Перу','Перу', 10),
        (1, 'Страны',  'Как называется самый высокий водопад в мире?','Виктория','Ниогарский','Игуасу','Ниогарский', 5),
        (2, 'Философы',  'Кто ввёл первые определения, аксиомы и методы доказательств теорем?', 'Пифагор', 'Конфуций', 'Сократ', 'Пифагор', 5),
        (2, 'Философы',  'Кто ученик Сократа?','Платон', 'Аристотель', 'Ксенофан', 'Платон', 10),
        (2, 'Философы',  'Кто римский император из династии Антонинов и последний из пяти хороших императоров?', 'Марк Аврелий', 'Траян', 'Тит', 'Марк Аврелий', 5),
        (3, 'Исторические факты', 'Какой человек правил Египтом в период своего правления в 1473-1458 годах до нашей эры?', 'Хеопс', 'Тутанхамон','Клеопатра', 'Клеопатра', 15),
        (3, 'Исторические факты', 'Какой главный город Америки был основан белыми колонистами в 1607 году?', 'Отман', 'Джеймстаун', 'Дедвуд', 'Джеймстаун', 15),
        (3, 'Исторические факты', 'Как назывался главный герой великой французской революции?', 'Робеспьер Максимилиан', 'Камиль Демулен', 'Жан-Поль Марат', 'Робеспьер Максимилиан', 15);
