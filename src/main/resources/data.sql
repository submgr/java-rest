...
VALUES  (1, 'Какой город является столицей Италии?','Рим','Милан','Венеция', 'Рим', 1, 1),
        (1, 'В какой стране находится город Мачу-Пикчу?','Португалия','Испания','Перу','Перу',2, 2),
        (1, 'Как называется самый высокий водопад в мире?','Виктория','Ниогарский','Игуасу','Ниогарский', 1, 3),
        (2, 'Кто ввёл первые определения, аксиомы и методы доказательств теорем?', 'Пифагор', 'Конфуций', 'Сократ', 'Пифагор', 2, 4),
        (2, 'Кто ученик Сократа?','Платон', 'Аристотель', 'Ксенофан', 'Платон', 1, 5),
        (2, 'Кто римский император из династии Антонинов и последний из пяти хороших императоров?', 'Марк Аврелий', 'Траян', 'Тит', 'Марк Аврелий', 1, 6),
        (3, 'Какой человек правил Египтом в период своего правления в 1473-1458 годах до нашей эры?', 'Хеопс', 'Тутанхамон','Клеопатра', 'Клеопатра', 1, 7),
        (3, 'Какой главный город Америки был основан белыми колонистами в 1607 году?', 'Отман', 'Джеймстаун', 'Дедвуд', 'Джеймстаун', 2, 8),
        (3, 'Как назывался главный герой великой французской революции?', 'Робеспьер Максимилиан', 'Камиль Демулен', 'Жан-Поль Марат', 'Робеспьер Максимилиан', 1, 9);
...
VALUES(1,'2023-04-20','middle','Страны', 1),
      (2,'2023-04-21','easy','Философы', 1),
      (3,'2023-04-22', 'hard', 'Исторические факты', 1);
